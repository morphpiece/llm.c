...
parser.add_argument("-t", "--tokenizer",type=str,choices=['morph','llama'],default='llama')
...
DATA_CACHE_DIR = os.path.join(os.path.dirname(__file__), local_dir,args.tokenizer)
os.makedirs(DATA_CACHE_DIR, exist_ok=True)

print('Data Dir: ', DATA_CACHE_DIR)
# download the dataset
fw = load_from_disk('/home/haris/fineweb-10b')

# init the tokenizer
if args.tokenizer=='morph':
    print('Using MorphPiece')
    enc = MorphPiece(merges_file='/home/haris/morph_llama_lower_32k/merges.txt',
                     vocab_file='/home/haris/morph_llama_lower_32k/vocab.json',
                     morpheme_file='/home/haris/morphtable_en.pkl')
    eot = enc.eos_token_id
else:
    print('Using Llama3-8B Tokenizer')
    enc = AutoTokenizer.from_pretrained("/home/haris/llama3-fw10b-32246")
